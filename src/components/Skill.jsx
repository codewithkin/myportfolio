...
const Skill = ({ included, title, icon, scheme }) => {
    return ( 
        <motion.section whileHover={{ x: 10, y: 40, boxShadow: '5px 10px' }} className=' relative grid bg-slate-700 align-middle justify-center items-center rounded-2xl mt-4 mb-4 p-4'>
            <Badge />
