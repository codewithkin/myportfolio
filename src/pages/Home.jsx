...
const Home = () => {
    ...
    return ( 
        <section>
            ...
            <section className="about bg-black p-6 text-white">
                <h2 className=" text-3xl">About me</h2>

                <section className=" grid items-center justify-center align-middle  md:grid-cols-2 md:grid-rows-1">
                    <article className="profile mt-4 self-center">
                        ...
                        <p className="text-2xl mt-2 self-center font-bold text-red-600">Kin Leon Zinzombe</p>
                    </article>
                    <article className="about-me text-center">
                        <p>
                            ...
                            When I was in the seventh grade in 2020, I developed an interest in programming because I was curious and wanted to understand how every component of a computer operated. Additionally, I wished to create my own software and apps.
                            One of my buddies, who was then in grade 12, introduced me to HTML during the lockdown. Numerous opportunities became available to me as I learned about HTML. As I dug deeper, I learned about CSS, JavaScript, Python, and C#, which would later become my preferred programming language.
                        </p>
                    </article>
                </section>
            </section>
